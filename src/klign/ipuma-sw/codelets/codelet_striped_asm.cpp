 ...
 */
class StripedSWAffineAsm : public poplar::Vertex {
private:
    poplar::Vector<half, poplar::VectorLayout::ONE_PTR, 8> C;
    poplar::Vector<half, poplar::VectorLayout::ONE_PTR, 8> bG;
public:
    // Fields
    poplar::Vector<poplar::Input<poplar::Vector<half, poplar::VectorLayout::ONE_PTR>>, poplar::VectorLayout::ONE_PTR> simMatrix;
    poplar::Input<int> maxNPerTile;
    poplar::Input<half> gapInit;
    poplar::Input<half> gapExt;
